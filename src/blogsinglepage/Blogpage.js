        ...
        <div className={classes.blog}>
            <div className={classes.container}>
                <div className={classes.left}>
                    <h1 className={classes.flutter}>Flutter-the boon for Android developers</h1>
            ...
            <div className={classes.morecontent}>
                <div className={classes.moreleft}>
                    ...
                    <p className={classes.morecont}>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse voluptatibus animi perspiciatis obcaecati quasi quod facere impedit quis veniam. Accusantium tenetur quia minima ex incidunt rerum in magni laborum eos.
